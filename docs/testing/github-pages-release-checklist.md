...
Use this checklist when turning `tactics-master` public and confirming the GitHub Pages production URL.
...
- Confirm the expected production URL is `https://emmassist-co.github.io/tactics-master/`.
...
4. Confirm the production site resolves under `/tactics-master/`, not `/`.
